...
const PROJECTS = [

  {
    ...
    desc: ' Developed a secure application to manage employee records including user login, registration, profile management, and CRUD operations. Implemented JWT authentication and authorization. Designed REST APIs for employee data management and integrated them with MySQL database ',
    ss: '/mamo.png',
    tech: ['TensorFlow', 'Keras', 'OpenCV', 'YOLOv8'],
    live: '#',
    code: 'https://github.com/anilmaurya078/EMPLOYEE-DETAILS-EMPLOYEE-LOGIN-FORM'
  },
  {
    title: ' ProductSubscriptionPanal',
    desc: ' Developed subscription-based system for product plans & payments.Designed REST APIs secured with Spring Security.Integrated Hibernate ORM with Oracle DB.  ',
    ss: '/mamo.png',
    tech: ['TensorFlow', 'Keras', 'OpenCV', 'YOLOv8'],
    live: '#',
    code: 'https://github.com/anilmaurya078/ProductSubscriptionPanal'
  },
  {
    title: ' Email-Messaging',
    desc: 'Developed a user management module to store details such as username, mobile number, email, and location.Implemented auto-generated passwords for new users.Configured dynamic email notifications to securely deliver login credentials to users.Enhanced system reliability and improved user onboarding experience through automated messaging.  ',
    ss: '/mamo.png',
    tech: ['TensorFlow', 'Keras', 'OpenCV', 'YOLOv8'],
    live: '#',
    code: 'https://github.com/anilmaurya078/Email-Messaging'
  },

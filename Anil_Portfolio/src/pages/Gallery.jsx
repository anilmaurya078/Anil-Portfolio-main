...
const IMAGES = {
  personal: [
    {
      ...
      photos: ["/gallery/matheran.jpeg", "/gallery/Mirzapur.jpeg"],
    },
    {
      id: 2,
      caption:
        "Weekend getaway to clear my head 🌄 Sometimes inspiration strikes when you’re away from the screen.",
      photos: ["/gallery/Kashi.jpeg", "/gallery/Hyderabad Charminar.jpeg"],
    },
  ],
  projects: [
    {
  ...
  achievements: [
    {
      id: 1,
      caption: "Solved target 1000+ LeetCode questions 🏆!",
      photos: ["/gallery/leet.png"],
    },
    {
      id: 2,
      caption: "Technical Trainee at Naresh IT Hyderabad 🤖",
      photos: ["/gallery/Hyderabad.jpeg"],
    },
  ],
};

...
const SKILLS = [
  ...
  { name: "JPA", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" },
  ...
  { name: "Spring Tool Suite", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" },
  ...
  { name: "Eureka Server", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" },
...
const ROWS = [
  [
    { title: "Programming Languages", items: ["SQL", "JavaScript", "Java"] },
    { title: "Web Technologies", items: ["HTML", "CSS", "Rest APIs", "JSON"] },
    { title: "Databases", items: ["MySQL", "MongoDB", "Oracle", "PostgreSQL"] },
    { title: "Frameworks", items: ["Spring Boot", "Spring Security", "Hibernate", "JPA"] },
    { title: "Tools & IDEs", items: ["Eclipse", "IntelliJ IDEA", "STS", "VS Code", "Git", "GitHub"] },
    { title: "Other", items: ["Microservices", "JWT Authentication", "Eureka Server", "Maven"] },
